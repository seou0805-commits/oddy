...
const TOTAL_SCROLL = 1650 // 11 frames × 150px — controls scrub length
...
export default function OrbitHero({
  ...
  // Mark ready once the browser has buffered enough to scrub
  useEffect(() => {
  ...
  return (
    <div ref={containerRef} style={{ height: `calc(100vh + ${TOTAL_SCROLL}px)` }}>
      <div style={{ position: "sticky", top: 0, height: "100vh", overflow: "hidden" }}>
        ...
        {/* <video ref={videoRef} src="/orbit-seq.mp4" preload="auto" muted playsInline style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} /> */}
