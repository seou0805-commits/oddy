...
export default function TipsyHero({
  color,
  tagline,
}: {
  color: string
  ...
  return (
    <div ref={containerRef} style={{ height: `calc(100vh + ${TOTAL_SCROLL}px)` }}>
      <div style={{ position: "sticky", top: 0, height: "100vh", overflow: "hidden" }}>
        ...
        {/* <video ref={videoRef} src="/tipsy-seq.mp4" preload="auto" muted playsInline style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} /> */}
